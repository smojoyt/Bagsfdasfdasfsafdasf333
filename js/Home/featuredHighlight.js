  ...
  container.innerHTML = `
    <div class="w-full grid grid-cols-1 md:grid-cols-2 items-stretch gap-0">
      ...
      <div class="p-10 lg:px-28 lg:py-18 flex flex-col justify-center items-center px-4 sm:px-6 space-y-6 text-center bg-[#fedcc1]">
        <h2 class="text-4xl md:text-4xl font-extrabold text-gray-800 uppercase">
          Home of the ${name}
        </h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div class="space-y-2">
            <div class="w-18 h-12 md:h-18 mx-auto flex items-center justify-center">
              ...
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                   class="w-8 h-8 md:w-12 md:h-12 text-gray-800" stroke="currentColor">
            ...
            <p class="text-base md:text-[1.25rem] font-semibold text-gray-800">
              ${leftText}
            </p>
          </div>
          ...
          <div class="space-y-2">
            <div class="w-18 h-12 md:h-18 mx-auto flex items-center justify-center">
              <!-- icon 2 -->
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                   class="w-8 h-8 md:w-12 md:h-12" stroke="currentColor">
        ...
        <div>
          <a href="${buyUrl}" class="inline-block mt-4 px-6 py-3 bg-black text-white text-lg font-semibold shadow hover:bg-gray-800 transition">
            Buy Now
          </a>
        </div>
      </div>
